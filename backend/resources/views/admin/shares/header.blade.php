  ...
  <nav class="navbar navbar-expand">
    ...
    <div class="user-box dropdown" style="padding-left: 20px">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
                <a class="dropdown-item" href="{{asset('/profile')}}"><i class="bx bx-user"></i><span>Hồ Sơ</span></a>
            </li>
            <li>
                <a class="dropdown-item" href="{{asset('/profile/changePassword')}}"><i class="bx bx-repost"></i><span>Đổi mật khẩu</span></a>
            </li>
            <li>
